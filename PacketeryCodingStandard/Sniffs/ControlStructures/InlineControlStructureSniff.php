 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PacketeryCodingStandard_Sniffs_ControlStructures_InlineControlStructureSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (isset($tokens[$stackPtr]['scope_opener']) === true || (isset($tokens[$stackPtr + 1]['parenthesis_closer']) && in_array($tokens[ $tokens[$stackPtr + 1]['parenthesis_closer'] + 2]['code'], $allowedStructures))) {
