 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class PacketeryCodingStandard_Sniffs_WhiteSpace_ObjectOperatorSpacingSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[($stackPtr - 1)]['code'] !== T_WHITESPACE) {
            ...
            while($tokens[($stackPtr - $i)]['code'] === T_WHITESPACE && $tokens[($stackPtr - $i)]['content'] !== "\n") $i++;
